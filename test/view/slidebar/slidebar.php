    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="register.html">Quản lý Sản phẩm</a>
                <a class="collapse-item" href="forgot-password.html">Quản lý danh mục sản phẩm</a>
                <a class="collapse-item" href="forgot-password.html">Quản lý loại sản phẩm</a>
