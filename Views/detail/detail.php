...
<div class="d-flex">
    <div class="d-flex">
        ...
        <div>
            <img class="" style="max-width: 634px; margin: 4px; border: 1px solid #dddddd;"
                 src="public/<?= $dataDetail['image1'] ?>" alt="">
    ...
    <div style="margin-left: 20px">
        ...
        <p>
            ...
            <span style="margin: 0 10px" class="label label-danger f12 border-0"><span class="fa-solid fa-heart" aria-hidden="true"></span> Giảm 13%  </span>
        ...
        <ul style="display: flex; list-style: none; flex-wrap: wrap;" class="p-0">
            <li class="text-center"
                ...
                <a href="#"><strong>43</strong>
                    <p class="text-muted m-0 fs-7">7.5 US</p></a>
            </li>
        </ul>
        ...
        <div class="container">
            <div class="d-inline-block mx-auto">
                ...
                <div class="input-group">
                    <button type="button" class="btn btn-outline-secondary btn-number" style="margin: 4px 0" disabled="disabled">
                        Quantity:
                    </button>
                    ...
                    <input type="text" style="margin: 4px 0;width: 40px; max-width: 40px;" name="quant[1]" class="form-control input-number text-center" value="1" min="1"
                           max="10">
            ...
            <button type="submit" name="submitbuy2" id="submitbuy2" value="submitbuy2" class="btn btn-primary d-inline-block" style="position: relative;top: -2px;">
